...
<?php 
		...
		$sql2 = 'UPDATE `board2` SET `view` = '.$view.'+1 WHERE `board`.`num` ='.$num.' ';
                    ...
                    <table>
                        ...
                        <tr >
                            <td colspan="3" style="text-align: left; padding : 20px 20px;">
                                ...
                                <br><br>
				첨부파일 : 
                                <a href="./action_php/download_공지사항.php?idx=<?php echo $num?>" target='_blank' style="color: black;"><?php echo $file?></a>
                            </td>
                        </tr>
                    </table>
                    <a href="./action_php/글삭제_공지사항.php?idx=<?php echo $num?>">삭제</a>
                    <a href="./메인_글수정_공지사항.php?idx=<?php echo $num?>">수정</a>
                    <a href="공지사항.php">글목록으로 돌아가기</a>
                    </div>
                    <div class="reply">
                        <table>
                            <tr>
                        ...
                        <table class="reply">
                            ...
                            $sql2 = 'SELECT * FROM `reply_board2` WHERE article_num ='.$num;	
                                $result2 =  mysqli_query($conn, $sql2);
...
<td>$content</td>
<td>$date</td>
<td style='width: 90px;'><a href='./action_php/댓글수정_공지사항.php?idx=$idx&article=$num' >수정</a> <a href='./action_php/댓글삭제_공지사항.php?idx=$idx&article=$num'>삭제</a></td>
</tr>";
