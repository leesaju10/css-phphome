...
<?php 
	...
	$block = 5; // 한 페이지에 보여줄 블록 갯수 
        ...
        $sql = 'select count(*) as total from board2';
...
<?php
	...
	if($start==0){$board_num=0;}
        ...
        $sql2 = "select * from board2 order by num desc limit $board_num, $list";
        ...
        <div class="main_wrap">
            ...
            <div class="main_section">
                ...
                <div class="right">
                    ...
                    <a href="공지사항.php?page=<?php if($s_page==1){echo 1;}else{echo $s_page-1;}?>">이전</a>
	                ...
	                //이전은 스타트 아래로 가면 이전 블록이 되고, 다음은 엔드 위로 가면 다음 블록이 된다.
	                 ...
	                 echo"<a href='공지사항.php?page=$p'>$p</a> ";
	                ...
	                <a href="공지사항.php?page=<?php if($e_page<$pageNum){echo $e_page+1;} else if($e_page==$pageNum){echo $pageNum;} ?>">다음</a>
